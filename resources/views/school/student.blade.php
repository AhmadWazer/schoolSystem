...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Students Tables</h4>
        <!-- cards -->
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-3 md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Totel Boys</span>
                ...
                <div class="col-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Totel Girls</span>
                ...
                <div class="col-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Totel Students</span>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="/student/addedit"><i
