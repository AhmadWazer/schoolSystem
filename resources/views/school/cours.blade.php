...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Courses Tables</h4>
        <!-- cards -->
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                <div class="col-3 md-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Active Courses</span>
                ...
                <div class="col-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="d-block mb-1">Pending Courses</span>
                ...
                <div class="col-3 mb-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Totel Courses</span>
            ...
            <div class="card">
                <h5 class="card-header">Table Courses</h5>
